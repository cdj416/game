package com.alipayjf.game.util.loading;

import android.content.Context;
import android.util.SparseArray;

import com.alipayjf.game.util.loading.animal.FishLoadingRenderer;
import com.alipayjf.game.util.loading.animal.GhostsEyeLoadingRenderer;
import com.alipayjf.game.util.loading.circle.jump.CollisionLoadingRenderer;
import com.alipayjf.game.util.loading.circle.jump.DanceLoadingRenderer;
import com.alipayjf.game.util.loading.circle.jump.GuardLoadingRenderer;
import com.alipayjf.game.util.loading.circle.jump.SwapLoadingRenderer;
import com.alipayjf.game.util.loading.circle.rotate.GearLoadingRenderer;
import com.alipayjf.game.util.loading.circle.rotate.LevelLoadingRenderer;
import com.alipayjf.game.util.loading.circle.rotate.MaterialLoadingRenderer;
import com.alipayjf.game.util.loading.circle.rotate.WhorlLoadingRenderer;
import com.alipayjf.game.util.loading.goods.BalloonLoadingRenderer;
import com.alipayjf.game.util.loading.goods.WaterBottleLoadingRenderer;
import com.alipayjf.game.util.loading.scenery.DayNightLoadingRenderer;
import com.alipayjf.game.util.loading.scenery.ElectricFanLoadingRenderer;
import com.alipayjf.game.util.loading.shapechange.CircleBroodLoadingRenderer;
import com.alipayjf.game.util.loading.shapechange.CoolWaitLoadingRenderer;
